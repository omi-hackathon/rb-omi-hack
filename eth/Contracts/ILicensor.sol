...
contract ILicensor {
    ...
    function GetRecording(uint _recordingID) constant public returns (uint, string, uint);
    function GetRecordingByISRC(string _isrc) constant public returns (uint, string, uint);
